            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Chapter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderIndex = 1,
                            SubjectId = 1,
                            Title = "Chuong 1: .NET Core và C# Nâng cao"
                        },
                        new
                        {
                            Id = 2,
                            ...
                            OrderIndex = 2,
                            SubjectId = 1,
                            Title = "Chuong 2: Entity Framework Core"
                        },
                        new
                        {
                            Id = 3,
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.QuestionBank", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Content = "T? khóa nào du?c dùng d? khai báo h?ng s? trong C#?",
                            CorrectAnswer = "B",
                        ...
                        {
                            Id = 2,
                            Content = "C# là m?t ngôn ng? l?p trình thu?n hu?ng d?i tu?ng (Pure Object-Oriented). Ðúng hay Sai?",
                            CorrectAnswer = "False",
                            CreatedAt = new DateTime(2026, 7, 8, 0, 0, 0, 0, DateTimeKind.Utc),
                            Difficulty = "Easy",
                            IsAIGenerated = false,
                        ...
                        {
                            Id = 3,
                            Content = "Middleware nào du?c s? d?ng d? ph?c v? các t?p tinh (static files) nhu HTML, CSS, JS trong ASP.NET Core?",
                            CorrectAnswer = "B",
                            CreatedAt = new DateTime(2026, 7, 8, 0, 0, 0, 0, DateTimeKind.Utc),
                            Difficulty = "Medium",
                            IsAIGenerated = false,
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Gói co b?n mi?n phí",
                            DurationDays = 30,
                            Features = "[\"H?i dáp AI co b?n\", \"Ð? tr? ph?n h?i bình thu?ng\", \"Gi?i h?n 5 câu h?i / 5 gi?\"]",
                            IsActive = true,
                        ...
                        {
                            Id = 2,
                            Description = "Gói nâng cao nhi?u tính nang",
                            DurationDays = 30,
                            Features = "[\"Uu tiên x? lý câu h?i\", \"T?c d? ph?n h?i AI nhanh hon\", \"Gi?i h?n 20 câu h?i / 5 gi?\", \"H? tr? tài li?u dính kèm\"]",
                            IsActive = true,
                        ...
                        {
                            Id = 3,
                            Description = "Gói cao c?p không gi?i h?n",
                            DurationDays = 30,
                            Features = "[\"Không gi?i h?n s? câu h?i\", \"AI ph?n h?i t?c thì\", \"Mô hình AI cao c?p nh?t\", \"H? tr? uu tiên 24/7\"]",
                            IsActive = true,
