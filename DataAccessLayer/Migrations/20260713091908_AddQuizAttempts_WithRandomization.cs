...
{
    /// <inheritdoc />
    public partial class AddQuizAttempts_WithRandomization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedAnswer = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizAnswers_QuestionBanks_QuestionBankId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAnswers_QuestionBankId",
                table: "QuizAnswers",
